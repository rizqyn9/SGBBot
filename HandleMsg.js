...
// ? MODULAR CASE SETPESAN.JS
const txt = require('./setPesan')
...
module.exports = HandleMsg = async (aruga, message) => {
    try {
        ...
        const isGroupList = groupList.includes(chatId)
	...
	// Filter Banned People
        ...
        //! Group List
        // if (isCmd && isGroupMsg && !isGroupList){
        //     return command = 'notRegist';
        // } else{
        //     continue;
        // }
        // console.log('OK')
        // if (isGroupMsg && !isGroupList){
        ...
        // ! MODULAR CASE SETPESAN.JS
        case txt.case1:
            await aruga.sendText(from, `${txt.textCase1}`) 
            break 
        
        case txt.case2:
            await aruga.sendText(from, `${txt.textCase2}`) 
            break 
        
        case txt.case3:
            await aruga.sendText(from, `${txt.textCase3}`) 
            break 
        
        case txt.case4:
            await aruga.sendText(from, `${txt.textCase4}`) 
            break 
        
        case txt.case5:
            await aruga.sendText(from, `${txt.textCase5}`) 
            break 
        
        case txt.case6:
            await aruga.sendText(from, `${txt.textCase6}`) 
            break 
        
        case txt.case7:
            await aruga.sendText(from, `${txt.textCase7}`) 
            break 
        
        case txt.case8:
            await aruga.sendText(from, `${txt.textCase8}`) 
            break 
        
        case txt.case9:
            await aruga.sendText(from, `${txt.textCase9}`) 
            break 
        
        case txt.case10:
            await aruga.sendText(from, `${txt.textCase10}`) 
            break 
        
        case txt.case11:
            await aruga.sendText(from, `${txt.textCase11}`) 
            break 
        
        case txt.case12:
            await aruga.sendText(from, `${txt.textCase12}`) 
            break 
        
        case txt.case13:
            await aruga.sendText(from, `${txt.textCase13}`) 
            break 
        
        case txt.case14:
            await aruga.sendText(from, `${txt.textCase14}`) 
            break 
        
        case txt.case15:
            await aruga.sendText(from, `${txt.textCase15}`) 
            break 
